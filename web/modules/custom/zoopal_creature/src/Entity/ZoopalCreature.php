...
class ZoopalCreature extends RevisionableContentEntityBase implements ZoopalCreatureInterface {
   ...
   * {@inheritdoc}
   *
   * When a new creature entity is created, set the uid entity reference to
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ->setRevisionable(TRUE)
      ->setLabel(t('Status'))
      ->setDescription(t('A boolean indicating whether the creature is enabled.'))
    ...
    $fields['description'] = BaseFieldDefinition::create('text_long')
      ...
      ->setDescription(t('A description of the creature.'))
      ->setDisplayOptions('form', [
        'type' => 'text_textarea',
        'weight' => 10,
      ])
    ...
    $fields['uid'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setTranslatable(TRUE)
      ->setLabel(t('Author'))
      ->setDescription(t('The user ID of the creature author.'))

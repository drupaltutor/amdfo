...
class ZoopalCreatureAccessControlHandler extends EntityAccessControlHandler {
    ...
    switch ($operation) {
      case 'view':
        ...
        return AccessResult::allowedIfHasPermission($account, 'view creature')
          ->andIf(AccessResult::allowedIf($entity->isEnabled()));

      case 'update':
        return AccessResult::allowedIfHasPermissions($account, ['edit creature', 'administer creature'], 'OR');

      case 'delete':
        return AccessResult::allowedIfHasPermissions($account, ['delete creature', 'administer creature'], 'OR');
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    return AccessResult::allowedIfHasPermissions($account, ['create creature', 'administer creature'], 'OR');
  }
